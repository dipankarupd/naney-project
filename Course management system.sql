...
insert into mainInfo values ('2020212223', 'Ramlal', 'admin', 'admin')
insert into mainInfo values ('2020212224', 'Ballari', 'admin', 'admin')
insert into mainInfo values ('2020212225', 'Achi Pattu', 'admin', 'admin')
insert into mainInfo values ('2020212226', 'Siyaram', 'admin', 'admin')
insert into mainInfo values ('2020212227', 'Belba', 'admin', 'admin')

insert into courses values ('mth1', 'math1', 'null', '2023-10-18', '2024-1-17', '30', '500', '1', 'cairo', '0')
insert into courses values ('cs111', 'intro to CS', 'null', '2023-10-18', '2024-1-17', '30', '1000', '1', 'cairo', '0')
